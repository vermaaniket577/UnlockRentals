...
<style>
    ...
    .is-mobile-app .ur-seo-guide-section,
    .no-web-navbar .ur-seo-guide-section {
...
@section('content')
<div class="min-h-screen ur-seo-guide-section pb-16 sm:pb-28 bg-[#fcfcfd] dark:bg-slate-950 relative overflow-hidden">
