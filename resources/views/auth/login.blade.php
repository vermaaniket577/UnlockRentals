...
<section class="min-h-screen flex items-center justify-center py-16 px-4" id="login-section"
    ...
    <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}" id="login-form">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('password.request') }}" class="text-xs text-[#2563EB] font-semibold hover:underline" title="Forgot password?">Forgot password?</a>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('social.redirect', 'google') }}" class="flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-500 hover:bg-gray-100 transition-all" title="Google">
                                <svg width="16" height="16" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
                                Google
                            </a>
                            <a href="{{ route('social.redirect', 'facebook') }}" class="flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-500 hover:bg-gray-100 transition-all" title="Facebook">
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <a href="{{ route('register') }}" class="text-[#2563EB] hover:text-[#1D4ED8] font-semibold transition-colors" title="Create one">Create one</a>
        </p>
