            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-stone-200/50">
                    ...
                    <tr class="hover:bg-stone-50/50">
                        ...
                        <td class="px-6 py-4">
                            @if($plan->is_active)
                                <span class="px-2 py-1 bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded-sm uppercase tracking-wider">Active</span>
                            @else
                                <span class="px-2 py-1 bg-zinc-100 text-zinc-500 text-[10px] font-bold rounded-sm uppercase tracking-wider">Inactive</span>
                            @endif
                            @if($plan->is_private)
                                <span class="ml-1 px-2 py-1 bg-indigo-100 text-indigo-700 text-[10px] font-bold rounded-sm uppercase tracking-wider inline-block mt-1">Private Offer</span>
                            @endif
                        </td>
