    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ $step ? route('admin.process-steps.update', $step) : route('admin.process-steps.store') }}"
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-stone-200">
                ...
                <a href="{{ route('admin.process-steps') }}" class="px-6 py-2.5 bg-stone-100 text-zinc-600 text-sm font-semibold rounded-sm hover:bg-stone-200 transition-all" title="Cancel">
                    Cancel
                </a>
            </div>
        </form>
