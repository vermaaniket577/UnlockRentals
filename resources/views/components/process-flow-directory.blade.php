{{-- ============================================================
     UNLOCK RENTAL — PREMIUM PROCESS FLOW (APPLE/STRIPE STYLE)
     ============================================================ --}}
...
<section class="ur-process" id="how-it-works">
    ...
    <div class="ur-process__container">
        ...
        <div class="ur-process__grid">
            ...
            {{-- Step 1 --}}
            <div class="ur-process__step" data-aos="fade-up" data-aos-delay="0">
                <div class="ur-process__visual">
                    <div class="ur-process__card">
                        <svg width="56" height="56" viewBox="0 0 24 24" fill="#2563eb" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 3.75A6.75 6.75 0 1010.5 17.25 6.75 6.75 0 0010.5 3.75zM2.25 10.5a8.25 8.25 0 1114.59 5.28l4.69 4.69a.75.75 0 11-1.06 1.06l-4.69-4.69A8.25 8.25 0 012.25 10.5z" /></svg>
                    </div>
                    <div class="ur-process__number">01</div>
                </div>
                <h3 class="ur-process__step-title">Discover</h3>
                <p class="ur-process__step-desc">
                    Explore India's most exclusive rental registry with intelligent lifestyle filters.
                </p>
            </div>

            {{-- Step 2 --}}
            <div class="ur-process__step" data-aos="fade-up" data-aos-delay="100">
                <div class="ur-process__visual">
                    <div class="ur-process__card">
                        <svg width="56" height="56" viewBox="0 0 24 24" fill="#2563eb" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.804 21.644A6.707 6.707 0 006 21.75a6.721 6.721 0 003.583-1.029c.774.182 1.584.279 2.417.279 5.322 0 9.75-3.97 9.75-9 0-5.03-4.428-9-9.75-9s-9.75 3.97-9.75 9c0 2.409 1.025 4.587 2.674 6.192.232.226.277.428.254.543a3.73 3.73 0 01-.814 1.686.75.75 0 00.44 1.223zM8.25 10.875a1.125 1.125 0 100 2.25 1.125 1.125 0 000-2.25zM10.875 12a1.125 1.125 0 112.25 0 1.125 1.125 0 01-2.25 0zm4.875-1.125a1.125 1.125 0 100 2.25 1.125 1.125 0 000-2.25z" /></svg>
                    </div>
                    <div class="ur-process__number">02</div>
                </div>
                <h3 class="ur-process__step-title">Concierge</h3>
                <p class="ur-process__step-desc">
                    Connect with premium owners or leverage our elite viewing concierge support.
                </p>
            </div>

            {{-- Step 3 --}}
            <div class="ur-process__step" data-aos="fade-up" data-aos-delay="200">
                <div class="ur-process__visual">
                    <div class="ur-process__card">
                        <svg width="56" height="56" viewBox="0 0 24 24" fill="#2563eb" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.5a5.25 5.25 0 00-5.25 5.25c0 1.942.868 3.659 2.146 4.815a1 1 0 01.354.757v4.928a2 2 0 002 2h3a2 2 0 002-2v-1h2a2 2 0 002-2v-1h2a2 2 0 002-2v-2.5a.75.75 0 00-.75-.75h-7.766a1 1 0 01-.84-.457 5.25 5.25 0 00-6.142-2.043zM10.5 5.25a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" /></svg>
                    </div>
                    <div class="ur-process__number">03</div>
                </div>
                <h3 class="ur-process__step-title">Finalize</h3>
                <p class="ur-process__step-desc">
                    Complete secure digital legalities and move into your handpicked luxury space.
                </p>
            </div>
        </div>
