        ...
        <div class="ur-app__flex">
            ...
            <div class="ur-app__content">
                ...
                <div class="ur-app__stores">
                    <a href="{{ (!empty($site_settings['app_google_play_url']) && $site_settings['app_google_play_url'] !== '#') ? $site_settings['app_google_play_url'] : route('app.download.apk') }}" target="_blank" class="ur-store-badge" title="Get it on Google Play">
                    ...
                    <a href="{{ (!empty($site_settings['app_store_url']) && $site_settings['app_store_url'] !== '#') ? $site_settings['app_store_url'] : route('app.download') }}" target="_blank" class="ur-store-badge" title="Download on the App Store">
                        <div class="ur-store-badge__icon">
