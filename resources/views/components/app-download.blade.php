{{-- ============================================================
     UNLOCK RENTAL — PREMIUM APP DOWNLOAD (LUXURY REGISTRY)
     ============================================================ --}}
        ...
        <div class="ur-app__flex">
            ...
            <div class="ur-app__visuals">
                ...
                <div class="ur-app__mockup-wrap">
                    {{-- Generated Mockup --}}
                    <img src="{{ asset('unlockrental_premium_mockup_1778934329998.png') }}" alt="UnlockRental Luxury App" class="ur-app__img">
