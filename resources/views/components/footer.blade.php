{{-- ============================================================
     UNLOCK RENTALS — LUXURY REGISTRY FOOTER (REMASTERED - NO TAILWIND)
     ============================================================ --}}
        ...
        <div class="ur-footer__grid">
            ...
            <div class="ur-footer__col">
                ...
                <div class="ur-footer__apps" style="display: flex; flex-direction: column; gap: 10px;">
                    <a href="{{ (!empty($site_settings['app_google_play_url']) && $site_settings['app_google_play_url'] !== '#') ? $site_settings['app_google_play_url'] : route('app.download.apk') }}" target="_blank" class="ur-store-badge" style="min-width: 150px; padding: 6px 14px; border-radius: 8px;" title="Get it on Google Play">
                    ...
                    <a href="{{ (!empty($site_settings['app_store_url']) && $site_settings['app_store_url'] !== '#') ? $site_settings['app_store_url'] : route('app.download') }}" target="_blank" class="ur-store-badge" style="min-width: 150px; padding: 6px 14px; border-radius: 8px;" title="Download on the App Store">
                        <div class="ur-store-badge__icon" style="width: 20px; height: 20px;">
