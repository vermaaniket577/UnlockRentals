        ...
        <div class="overflow-y-auto flex-1 p-4 sm:p-5 overscroll-contain" id="ur-auth-modal-body">
            ...
            <div class="website-only-social mb-3">
                ...
                <div class="relative flex items-center justify-center my-3">
                    ...
                    <span class="bg-white dark:bg-slate-900 px-2.5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider absolute">or continue with email</span>
                </div>
            </div>
            @endif
