...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::match(['delete', 'post'], '/callbacks/{id}', [AdminController::class, 'destroyCallback'])->name('callbacks.destroy');
    Route::get('/callbacks/{id}/delete', [AdminController::class, 'destroyCallback'])->name('callbacks.destroy.get');
