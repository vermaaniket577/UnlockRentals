...
class LocationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $districts = [
            ...
            'GJ' => ['Ahmedabad', 'Amreli', 'Anand', 'Aravalli', 'Banaskantha', 'Bharuch', 'Bhavnagar', 'Botad', 'Chhota Udepur', 'Dahod', 'Dang', 'Devbhumi Dwarka', 'Gandhinagar', 'Gir Somnath', 'Jamnagar', 'Junagadh', 'Kheda', 'Kutch', 'Mahisagar', 'Mehsana', 'Morbi', 'Narmada', 'Navsari', 'Panchmahal', 'Patan', 'Porbrandar', 'Rajkot', 'Sabarkantha', 'Surat', 'Surendranagar', 'Tapi', 'Vadodara', 'Valsad'],
            'UP' => ['Agra', 'Aligarh', 'Prayagraj', 'Lucknow', 'Kanpur Nagar', 'Varanasi', 'Meerut', 'Ghaziabad', 'Gautam Buddha Nagar', 'Bareilly', 'Moradabad', 'Saharanpur', 'Gorakhpur', 'Jhansi', 'Mathura', 'Firozabad', 'Ayodhya'],
        ...
        $localities = [
            ...
            'aizawl' => ['Aizawl (State Capital)', 'Sairang', 'Saitual', 'Darlawn', 'Tlangnuam', 'Aibawk', 'Thingsulthliah', 'Phullen'],
            'lunglei' => ['Lunglei', 'Hnahthial', 'Tlabung', 'Lungsen', 'West Bunghmun', 'Pangzawl'],
            'champhai' => ['Champhai', 'Khawzawl', 'Khawhai', 'Biate', 'Ngopa', 'Khawbung'],
            'kolasib' => ['Kolasib', 'Vairengte', 'Bairabi', 'N. Kawnpui', 'Bilkhawthlir', 'N Thingdawl'],
            'lawngtlai' => ['Lawngtlai', 'Chawngte', 'Sangau', 'S\' Bungtlang', 'Kamalanagar', 'Bungtlang South'],
            'mamit' => ['Mamit', 'Zawlnuam', 'Lengpui', 'West Phaileng', 'Reiek', 'Kanhmun'],
            'saiha-(siaha)' => ['Siaha', 'Tuipang', 'Phura', 'Sangau', 'Tipa'],
            'siaha' => ['Siaha', 'Tuipang', 'Phura', 'Sangau', 'Tipa'],
        ...
        foreach ($states as $code => $name) {
            ...
            if (isset($districts[$code])) {
                foreach ($districts[$code] as $districtName) {
                    $districtsData[] = [
                        'id' => $districtId,
                        'state_id' => $stateId,
                        'name' => $districtName
                    ...
                    if (isset($localities[$slug])) {
                        foreach ($localities[$slug] as $localityName) {
                            $localitiesData[] = [
                                'id' => $localityId,
        ...
        // Insert in bulk chunks to prevent SQL query limit errors
        ...
        foreach (array_chunk($localitiesData, 100) as $chunk) {
